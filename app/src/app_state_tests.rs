...
#[test]
fn codex_adapter_configuration_is_hidden_when_feature_is_disabled() {
...
#[test]
fn codex_adapter_configuration_is_exposed_when_feature_is_enabled() {
    ...
    assert!(CODEX_AGENT_ADAPTER.permission_modes().is_empty());
}
