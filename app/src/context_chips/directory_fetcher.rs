...
use twarp_completer::completer::{EngineDirEntry, EngineFileType, PathCompletionContext};
use twarp_util::file_type::is_binary_file;
use twarpui::{r#async::SpawnedFutureHandle, AppContext, Entity, ModelContext};
