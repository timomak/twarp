                        ...
                        me.api_keys = keys
                            ...
                            .map(|gql_key| {
                                ...
                                let scope = match gql_key.owner_type {
                                    twarp_graphql::object_permissions::OwnerType::User => {
                                        ApiKeyScope::Personal
                                    }
                                    twarp_graphql::object_permissions::OwnerType::Team => {
                                        ApiKeyScope::Team
                                    }
                                };
        ...
        match event {
            ...
            CreateApiKeyModalEvent::Created { api_key } => {
                ...
                let scope = match api_key.owner_type {
                    twarp_graphql::object_permissions::OwnerType::User => ApiKeyScope::Personal,
                    twarp_graphql::object_permissions::OwnerType::Team => ApiKeyScope::Team,
                };
...
impl PlatformPageWidget {
    fn render_description_with_link(
        ...
        let text = vec![
            FormattedTextFragment::plain_text("Create and manage API keys to allow other Oz cloud agents to access your Twarp account.\nFor more information, visit the "),
            ...
            Align::new(
                Flex::column()
                    ...
                    .with_child(
                        Container::new(
                            Text::new(
                                "Create a key to manage external access to Twarp",
                                appearance.ui_font_family(),
                                CONTENT_FONT_SIZE,
                            )
                            .with_color(appearance.theme().active_ui_text_color().into())
