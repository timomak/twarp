...
static SAFE_MODE_DESCRIPTION: LazyLock<&'static str> = LazyLock::new(|| {
    "When this setting is enabled, Twarp will scan blocks, the contents of \
        Twarp Drive objects, and Oz prompts for potential sensitive \
...
const TELEMETRY_TITLE: &str = "Help improve Twarp";
const TELEMETRY_DESCRIPTION: &str =
    "App analytics help us make the product better for you. We may collect \
    certain console interactions to improve Twarp's cloud capabilities.";
...
const DATA_MANAGEMENT_DESCRIPTION: &str =
    "At any time, you may choose to delete your Twarp account permanently. \
    You will no longer be able to use Twarp.";
const DATA_MANAGEMENT_LINK_TEXT: &str = "Visit the data management page";

const PRIVACY_POLICY_TITLE: &str = "Privacy policy";
const PRIVACY_POLICY_LINK_TEXT: &str = "Read Twarp's privacy policy";
    ...
    fn render(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        "Read more about Twarp's use of data".into(),
