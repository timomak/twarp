...
use twarpui::keymap::{DescriptionContext, Keystroke};
...
impl SearchItemIcon for BindingGroup {
    ...
    fn icon_color(&self, appearance: &Appearance) -> ColorU {
        match self {
            ...
            | Self::Terminal
            | Self::Notifications
            | Self::TabColor => appearance.theme().foreground().into_solid(),
            ...
            Self::Workflow => twarp_drive_icon_color(appearance, DriveObjectType::Workflow),
            Self::Notebooks => twarp_drive_icon_color(
                appearance,
            ...
            Self::EnvVarCollection => {
                twarp_drive_icon_color(appearance, DriveObjectType::EnvVarCollection)
            }
        }
    }
}
