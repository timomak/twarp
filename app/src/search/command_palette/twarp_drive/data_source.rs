...
pub struct DataSource {
    searcher: Box<dyn TwarpDriveSearcher>,
}
...
impl DataSource {
    ...
    pub fn new_fuzzy(ctx: &mut ModelContext<Self>) -> Self {
        ...
        let mut searcher = Box::new(FuzzyTwarpDriveSearcher::default());
    ...
    fn new_full_text(ctx: &mut ModelContext<Self>) -> Self {
        ctx.subscribe_to_model(&CloudModel::handle(ctx), Self::handle_cloud_object_updated);
        let mut searcher = Box::new(full_text_searcher::FullTextTwarpDriveSearcher::new(
...
#[derive(Default)]
struct FuzzyTwarpDriveSearcher {
...
impl TwarpDriveSearcher for FuzzyTwarpDriveSearcher {
    fn insert_searchable_object(
        &mut self,
        object: &dyn CloudObject,
        object_type: ObjectType,
...
mod full_text_searcher {
    ...
    use crate::notebooks::CloudNotebook;
    use crate::search::command_palette::twarp_drive::data_source::TwarpDriveSearcher;
    use crate::search::command_palette::twarp_drive::env_var_collection_search_item::{
        EnvVarCollectionSearchItem, ENV_VAR_NAME_SEPARATOR,
    };
    use crate::search::command_palette::twarp_drive::notebook_search_item::NotebookSearchItem;
    use crate::search::command_palette::twarp_drive::workflow_search_item::WorkflowSearchItem;
    use crate::search::env_var_collections::fuzzy_match::FuzzyMatchEnvVarCollectionResult;
    use crate::search::notebooks::fuzzy_match::FuzzyMatchNotebookResult;
    ...
    pub(crate) struct FullTextTwarpDriveSearcher {
    ...
    impl FullTextTwarpDriveSearcher {
    ...
    impl TwarpDriveSearcher for FullTextTwarpDriveSearcher {
        fn insert_searchable_object(
            &mut self,
            object: &dyn CloudObject,
            object_type: ObjectType,
