...
use twarpui::{r#async::executor::BackgroundTask, AppContext, SingletonEntity};
...
pub fn pass_startup_args_to_existing_instance(
    ...
    twarpui::r#async::block_on(async {
...
impl DBusServiceHost {
    ...
    fn terminate(&mut self) {
        if let Some(server_task) = self.server_task.take() {
            ...
            report_if_error!(twarpui::r#async::block_on(server_task));
        }
    }
...
impl twarpui::Entity for DBusServiceHost {
    type Event = ();
}
