...
#[derive(Default)]
pub struct AIMemory {
    // twarp: 2c-d — fields used by callers (Option for nullable text)
    pub suggested_logging_id: Option<String>,
...
impl crate::drive::items::WarpDriveItem for WarpDriveAIFactCollection {
    ...
    fn object_type(&self) -> Option<crate::drive::DriveObjectType> {
        None
    }
    fn secondary_icon(
        &self,
...
const PAYMENT_ISSUE_BANNER_LINE_2_ADMIN_ENTERPRISE: &str =
    "Please open a GitHub issue to restore access.";
...
impl DriveIndex {
            ...
            (DriveIndexVariant::MainIndex, DriveIndexSection::JoinTeam) => {
                if self.is_online(app) {
                    let join_teams_text = format!(
                        "Collaborate with {} of your teammates already on Twarp.",
            ...
            |mouse_state| {
                ...
                if mouse_state.is_hovered() {
                    let tooltip = appearance
                        .ui_builder()
                        .tool_tip(String::from("Syncing Twarp Drive"));
    ...
    fn render_personal_limit_status(
        ...
        let header = Flex::row()
            ...
            .with_main_axis_alignment(MainAxisAlignment::SpaceBetween)
            .with_child(
                Text::new_inline("Twarp Drive".to_string(), appearance.ui_font_family(), 14.)
