...
use crate::workspace::view::{
    ...
    NEW_TAB_BINDING_NAME, NEW_TERMINAL_TAB_BINDING_NAME, OPEN_BROWSER_PANE_BINDING_NAME,
...
pub fn init(app: &mut AppContext) {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                EditableBinding::new(
                    ...
                    "[Debug] Install OpenCode Twarp plugin",
                    WorkspaceAction::InstallOpenCodeWarpPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_warp_plugin",
                    "[Debug] Use local OpenCode Twarp plugin (testing only)",
    ...
    app.register_editable_bindings([
        ...
        .with_enabled(|| ContextFlag::CreateNewSession.is_enabled()),
        // twarp: cmd-shift-T opens a fresh Claude Code pane in a new tab.
        EditableBinding::new(
            OPEN_CLAUDE_CODE_TAB_BINDING_NAME,
            BindingDescription::new("Open Claude in New Tab"),
            WorkspaceAction::OpenClaudeCodeInNewTab,
        )
        .with_context_predicate(id!("Workspace") & !id!("Workspace_PaneDragging"))
        .with_custom_action(CustomAction::OpenClaudeCodeInNewTab)
        .with_enabled(|| ContextFlag::CreateNewSession.is_enabled()),
        EditableBinding::new(
            OPEN_BROWSER_PANE_BINDING_NAME,
            BindingDescription::new("New Browser Pane"),
            WorkspaceAction::OpenBrowserPane,
        )
        .with_context_predicate(id!("Workspace") & !id!("Workspace_PaneDragging"))
        .with_custom_action(CustomAction::OpenBrowserPane)
        .with_enabled(|| ContextFlag::CreateNewSession.is_enabled()),
        EditableBinding::new(
            OPEN_BROWSER_SPIKE_PANE_BINDING_NAME,
            BindingDescription::new("Open Browser Spike Pane"),
            WorkspaceAction::OpenBrowserSpikePane,
        )
        .with_context_predicate(id!("Workspace") & !id!("Workspace_PaneDragging"))
        .with_enabled(|| ContextFlag::CreateNewSession.is_enabled()),
        EditableBinding::new(
    ...
    // The agent-mode "new pane" binding is registered under the legacy
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Open Plugins")
            .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Open Plugins"),
    ...
    // twarp: 2d — `workspace:toggle_agent_management_view` binding deleted with
    // FeatureFlag::AgentManagementView; the underlying ToggleAgentManagementView
    // action is a no-op stub left from the agent_management deletion.
}
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Twarp"),
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // twarp: 2d — `workspace:show_ai_settings_page` binding deleted with WarpAgent settings page.
        EditableBinding::new(
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: Plugins"),
