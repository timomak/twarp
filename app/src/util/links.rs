...
pub const GITHUB_ISSUES_URL: &str = "https://github.com/timomak/twarp/issues";
...
pub fn feedback_form_url() -> String {
    let mut url = url::Url::parse("https://github.com/timomak/twarp/issues/new/choose")
        .expect("Should not fail to parse");
    if let Some(version) = ChannelState::app_version() {
        url.query_pairs_mut().append_pair("twarp-version", version);
    }
    url.query_pairs_mut()
