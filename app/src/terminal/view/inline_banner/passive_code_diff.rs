...
impl Entity for CodeDiffView { type Event = (); }
impl View for CodeDiffView {
    fn ui_name() -> &'static str { "CodeDiffView/twarp-stub" }
    fn render(&self, _: &AppContext) -> Box<dyn Element> { warpui::elements::Empty::new().finish() }
}
