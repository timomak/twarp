...
const TITLE_TEXT: &str = "Sharing in Twarp Drive";
const BODY_TEXT: &[&str] = &[
    "You can now share drive objects, in Twarp or on the web, with anyone - Twarp user or not. Click Share in the Twarp Drive menu or the pane header to share via link or email.",
