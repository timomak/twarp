...
use crate::terminal::autosuggestion_validation::{
    find_potential_autosuggestions_from_history, is_command_valid,
};
...
const AGENT_MODE_HINT_OPTIONS: &[&str] = &[
    "Twarp anything e.g. Deploy my React app to Vercel and set up environment variables",
    "Twarp anything e.g. Help me debug why my Python tests are failing in CI",
    "Twarp anything e.g. Set up a new microservice with Docker and create the deployment pipeline",
    "Twarp anything e.g. Find and fix the memory leak in my Node.js application",
    "Twarp anything e.g. Create a backup script for my PostgreSQL database and schedule it",
    "Twarp anything e.g. Help me migrate my data from MySQL to PostgreSQL",
    "Twarp anything e.g. Set up monitoring and alerts for my AWS infrastructure",
    "Twarp anything e.g. Build a REST API for my mobile app using FastAPI",
    "Twarp anything e.g. Help me optimize my SQL queries that are running slowly",
    "Twarp anything e.g. Create a GitHub Actions workflow to automatically deploy on merge",
    "Twarp anything e.g. Set up Redis caching for my web application",
    "Twarp anything e.g. Help me troubleshoot why my Kubernetes pods keep crashing",
    "Twarp anything e.g. Build a data pipeline to process CSV files and load them into BigQuery",
    "Twarp anything e.g. Set up SSL certificates and configure HTTPS for my domain",
    "Twarp anything e.g. Help me refactor this legacy code to use modern design patterns",
    "Twarp anything e.g. Create unit tests for my authentication service",
    "Twarp anything e.g. Set up log aggregation with ELK stack for my distributed system",
    "Twarp anything e.g. Help me implement OAuth2 authentication in my Express.js app",
    "Twarp anything e.g. Optimize my Docker images to reduce build times and size",
    "Twarp anything e.g. Set up A/B testing infrastructure for my web application",
];
            ...
            .spawn_abortable(
                async move {
                    ...
                    if let Some(conn) = conn {
                        ...
                        {
                            let similar_next_commands: Vec<crate::persistence::model::Command> = {
                                ...
                                same_commands
                                    .into_iter()
                                    .filter_map(|cmd| {
                                        crate::persistence::commands::get_next_command(
                                            &mut conn, &cmd,
                                        )
                                        .ok()
                                    })
                            ...
                            if !similar_next_commands.is_empty() {
                                ...
                                for next_command in &similar_next_commands {
