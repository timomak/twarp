...
//! keychain holds the keys; `AgentSettings::voice_stt_config()` resolves them
//! into this struct, or `None` when the provider is unconfigured (which drives
//! the mic button's unconfigured behavior, PRODUCT §2).
