...
impl PaneId {
    ...
    pub fn from_browser_spike_pane_view(
        browser_spike_pane_view: &ViewHandle<PaneView<BrowserSpikeView>>,
    ) -> Self {
        Self::new(IPaneType::BrowserSpike, browser_spike_pane_view)
    }
    ...
    pub fn is_twarp_drive_object_pane(&self) -> bool {
        matches!(
            self.0.pane_type,
            IPaneType::Notebook
                | IPaneType::Workflow
