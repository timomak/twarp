...
use twarpui::elements::{Align, ConstrainedBox, ParentElement, Rect, Stack};
use twarpui::fonts::FamilyId;
use twarpui::SingletonEntity as _;
use twarpui::{AppContext, Element, Entity, TypedActionView, View, ViewContext};
...
impl RootView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        let font_family = twarpui::fonts::Cache::handle(ctx).update(ctx, |cache, _| {
            cache
