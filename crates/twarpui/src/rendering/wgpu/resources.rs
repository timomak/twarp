...
use thiserror::Error;
use twarpui_core::rendering::{GPUBackend, GPUDeviceInfo, GPUDeviceType};
...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for twarpui
/// to render properly.
...
/// twarpui to render properly. Currently, we limit this to "Intel UHD Graphics 620", but we do have
...
/// (Vulkan llvmpipe) adapter that may not work properly with twarpui.
