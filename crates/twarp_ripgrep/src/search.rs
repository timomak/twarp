...
mod process_impl {
    ...
    pub async fn search(
        ...
        let stream = search_streaming(patterns, paths, ignore_case, multiline, includes, excludes)?;
    ...
    fn spawn_search_process(
        ...
        cmd.arg(twarp_cli::ripgrep_search_subcommand())
            .arg(twarp_cli::parent_flag());
