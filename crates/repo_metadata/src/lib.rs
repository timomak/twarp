...
pub use entry::{
    gitignores_for_directory, is_git_internal_path, matches_gitignores, path_passes_filters,
    should_ignore_git_path, BuildTreeError, DirectoryEntry, Entry, FileId, FileMetadata,
};
...
#[cfg(not(target_family = "wasm"))]
pub fn is_in_repo(path: &str, app: &twarpui::AppContext) -> bool {
...
pub fn is_in_repo(_path: &str, _app: &twarpui::AppContext) -> bool {
    false
}
