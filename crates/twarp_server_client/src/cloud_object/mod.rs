...
use twarp_graphql::{object_permissions::AccessLevel, scalars::time::ServerTimestamp};
use twarpui_core::{
    Element,
    elements::{
...
impl TryFrom<twarp_graphql::object::ObjectType> for ObjectIdType {
    type Error = anyhow::Error;
    fn try_from(object_type: twarp_graphql::object::ObjectType) -> Result<Self, Self::Error> {
        match object_type {
            twarp_graphql::object::ObjectType::AIConversation => Err(anyhow!(
                "AIConversation is not a supported object type for this operation"
            )),
            twarp_graphql::object::ObjectType::Notebook => Ok(ObjectIdType::Notebook),
            twarp_graphql::object::ObjectType::Workflow => Ok(ObjectIdType::Workflow),
            twarp_graphql::object::ObjectType::Folder => Ok(ObjectIdType::Folder),
            twarp_graphql::object::ObjectType::GenericStringObject => {
                Ok(ObjectIdType::GenericStringObject)
            }
            twarp_graphql::object::ObjectType::Unknown => {
...
impl From<ObjectType> for twarp_graphql::object::ObjectType {
    fn from(value: ObjectType) -> Self {
        match value {
            ObjectType::Notebook => twarp_graphql::object::ObjectType::Notebook,
            ObjectType::Workflow => twarp_graphql::object::ObjectType::Workflow,
            ObjectType::Folder => twarp_graphql::object::ObjectType::Folder,
            ObjectType::GenericStringObject(GenericStringObjectFormat::Json(
                JsonObjectType::EnvVarCollection,
            )) => twarp_graphql::object::ObjectType::GenericStringObject,
...
impl From<GenericStringObjectFormat>
    for twarp_graphql::generic_string_object::GenericStringObjectFormat
{
    fn from(format: GenericStringObjectFormat) -> Self {
        use twarp_graphql::generic_string_object::GenericStringObjectFormat as GraphQLFormat;
        match format {
...
impl From<CloudObjectEventEntrypoint> for twarp_graphql::object::CloudObjectEventEntrypoint {
    fn from(entrypoint: CloudObjectEventEntrypoint) -> Self {
        use twarp_graphql::object::CloudObjectEventEntrypoint as GraphQLEntrypoint;
        match entrypoint {
...
impl TryFrom<twarp_graphql::object::ObjectMetadata> for ServerMetadata {
    type Error = anyhow::Error;

    fn try_from(value: twarp_graphql::object::ObjectMetadata) -> Result<Self, Self::Error> {
        let folder_id: Option<FolderId> = match value.parent {
            twarp_graphql::object::Container::FolderContainer(folder_container) => {
...
impl TryFrom<twarp_graphql::object_permissions::ObjectPermissions> for ServerPermissions {
    type Error = anyhow::Error;

    fn try_from(
        value: twarp_graphql::object_permissions::ObjectPermissions,
...
impl TryFrom<twarp_graphql::object_permissions::ObjectGuest> for ServerObjectGuest {
    type Error = anyhow::Error;

    fn try_from(
        value: twarp_graphql::object_permissions::ObjectGuest,
    ) -> Result<Self, Self::Error> {
...
impl TryFrom<twarp_graphql::object_permissions::GuestSubject> for ServerGuestSubject {
    type Error = anyhow::Error;

    fn try_from(
        value: twarp_graphql::object_permissions::GuestSubject,
    ) -> Result<Self, Self::Error> {
        match value {
            twarp_graphql::object_permissions::GuestSubject::UserGuest(user_guest) => {
                let guest_subject = ServerGuestSubject::User {
                    firebase_uid: user_guest.firebase_uid.into_inner(),
                };
                Ok(guest_subject)
            }
            twarp_graphql::object_permissions::GuestSubject::PendingUserGuest(guest) => {
                Ok(ServerGuestSubject::PendingUser { email: guest.email })
            }
            twarp_graphql::object_permissions::GuestSubject::TeamGuest(team_guest) => {
                Ok(ServerGuestSubject::Team {
                    team_uid: ServerId::from_string_lossy(team_guest.uid.inner()),
                })
            }
            twarp_graphql::object_permissions::GuestSubject::Unknown => {
...
impl TryFrom<twarp_graphql::object_permissions::LinkSharing> for ServerLinkSharing {
    type Error = anyhow::Error;

    fn try_from(
        value: twarp_graphql::object_permissions::LinkSharing,
    ) -> Result<Self, Self::Error> {
...
impl TryFrom<twarp_graphql::object::Container> for ServerObjectContainer {
    type Error = anyhow::Error;

    fn try_from(value: twarp_graphql::object::Container) -> Result<Self, Self::Error> {
        match value {
            twarp_graphql::object::Container::FolderContainer(folder) => {
                Ok(ServerObjectContainer::Folder {
                    folder_uid: ServerId::from_string_lossy(folder.folder_uid.inner()),
                })
            }
            twarp_graphql::object::Container::Space(space) => Ok(ServerObjectContainer::Drive {
                owner: space.try_into()?,
            }),
            twarp_graphql::object::Container::Unknown => {
...
impl TryFrom<twarp_graphql::object::Space> for Owner {
    type Error = anyhow::Error;

    fn try_from(value: twarp_graphql::object::Space) -> Result<Self, Self::Error> {
        let owner = match value.type_ {
            twarp_graphql::object::SpaceType::Team => Owner::Team {
                team_uid: ServerId::from_string_lossy(value.uid.inner()),
            },
            twarp_graphql::object::SpaceType::User => Owner::User {
...
impl From<Owner> for twarp_graphql::object_permissions::Owner {
    fn from(owner: Owner) -> Self {
        use twarp_graphql::object_permissions::Owner as GraphQLOwner;
