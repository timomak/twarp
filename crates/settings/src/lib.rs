...
impl PublicPreferences {
    ...
    pub fn reload_from_disk(&self) -> Result<(), twarpui_extras::user_preferences::Error> {
        self.0.reload_from_disk()
    }
}

impl twarpui::Entity for PublicPreferences {
    type Event = ();
}

impl twarpui::SingletonEntity for PublicPreferences {}
...
impl twarpui::Entity for PrivatePreferences {
    type Event = ();
}

impl twarpui::SingletonEntity for PrivatePreferences {}
