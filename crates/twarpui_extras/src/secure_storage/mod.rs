...
/// A type alias for the concrete type stored within a twarpui
...
pub fn register(service_name: &str, ctx: &mut twarpui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut twarpui::AppContext) {
...
impl twarpui::Entity for Model {
    type Event = ();
}

impl twarpui::SingletonEntity for Model {}
...
impl AppContextExt for twarpui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
