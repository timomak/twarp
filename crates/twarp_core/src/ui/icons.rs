...
/// Icon enum to be used within the app in place of the twarpui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::Archive => "bundled/svg/inbox-01.svg",
            ...
            Icon::TwarpDrive => "bundled/svg/twarp.svg",
            Icon::Warp => "bundled/svg/twarp-drive.svg",
            Icon::WarpLogoLight => "bundled/svg/twarp-logo-light.svg",
            ...
            Icon::Warping0 => "bundled/svg/twarp-loading-0.svg",
            Icon::Warping1 => "bundled/svg/twarp-loading-1.svg",
            Icon::Warping2 => "bundled/svg/twarp-loading-2.svg",
            Icon::Warping3 => "bundled/svg/twarp-loading-3.svg",
            Icon::Warping4 => "bundled/svg/twarp-loading-4.svg",
            Icon::Warping5 => "bundled/svg/twarp-loading-5.svg",
            Icon::Warping6 => "bundled/svg/twarp-loading-6.svg",
            Icon::Warping7 => "bundled/svg/twarp-loading-7.svg",
            Icon::Warping8 => "bundled/svg/twarp-loading-8.svg",
            Icon::Warping9 => "bundled/svg/twarp-loading-9.svg",
            Icon::Warping10 => "bundled/svg/twarp-loading-10.svg",
            Icon::Warping11 => "bundled/svg/twarp-loading-11.svg",
