...
// twarp: de-cloud (2b) — the "Log in" link (and its LoginRequested event)
// was deleted; there is no login.
#[derive(Clone, Debug)]
...
impl View for IntroSlide {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        // twarp: de-cloud (2b) — the "Already have an account? Log in" row was
        // deleted with the login flow.
