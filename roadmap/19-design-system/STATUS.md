...
- [ ] **19b — the Codex shell.** Full-height left sidebar (layout inversion behind `DesignShellV1` flag, traffic-light zone, tab-strip origin), right-panel inspector restyle.
