...
**Phase:** impl-in-review — **7d (tool cards) PR [#75](https://github.com/timomak/twarp/pull/75) open.** 7c live driver merged ([#72](https://github.com/timomak/twarp/pull/72)); shell-polish + session-metadata chips merged ([#74](https://github.com/timomak/twarp/pull/74)). After 7d merges: **7e (diff cards)**; remaining 7e–7h.
