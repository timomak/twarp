...
**Phase:** impl-pending — **7c live driver merged ([#72](https://github.com/timomak/twarp/pull/72)); shell-polish + session-metadata chips merged ([#74](https://github.com/timomak/twarp/pull/74), which superseded auto-closed [#73](https://github.com/timomak/twarp/pull/73)).** Next sub-phase: **7d (tool cards)**; remaining 7d–7h.
